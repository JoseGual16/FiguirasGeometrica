...
public class TrianguloRectangulo {
     ...
     *              rectángulo
     * @param altura Prámetro que define la altura de un triángulo
     *               rectángulo
     */
    ...
    /**
     * Método que calcula y devulve el perímetro de un triángulo
     * rectángulo como la suma de la base, la altura, y la hipotenusa
     * 
     * @return Perímetro de un triángulo rectángulo
     */
    public double calcularPerimetro(){
        return (base + altura + calcularHipotenusa()); /**Invoca al metódo calcula hipotenusa */
    }

    /**
     * Método que calcula y devuelve la hípotenusa de un triángulo
     * rectángulo utilizando el teorema de Pitágoras
     * @return Hípotenusa de un triángulo rectángulo
     */
 ...
 * - Equílatero: si sus tres lados son iguales
